...
mod imp {
    ...
    use gio::Cancellable;
    use glib::{clone, subclass::Signal, JoinHandle, ObjectExt, Pid, Properties, SignalHandlerId, SpawnFlags, StaticType, Type, Value};
    use gtk::{ffi::gtk_application_get_active_window, GestureClick};
    use once_cell::sync::Lazy;
    use shell_quote::Sh;
    use vte::{CancellableExt, PopoverExt, PtyFlags, TerminalExt, TerminalExtManual, WidgetExt};
